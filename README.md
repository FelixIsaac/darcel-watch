...
This was caught by reviewing the two runs side by side and asking whether the source for both was the same. It was not. That check is now the reason this project only publishes findings sourced from v2.
